...
{
    public partial class PVTFromFile : Form
    {
        //***************************************************
        //*
        //*  EtherCAT Network
        ...
        private void PVTFromFile_Load(object sender, EventArgs e)
        {
            try
            {
                //**************************************************************************
        ...
        private void PVTFromFile_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
