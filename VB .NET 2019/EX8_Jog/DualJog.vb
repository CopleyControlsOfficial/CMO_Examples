...
'    Upon startup it will enable one axis at Can Node ID 1 and
...
Public Class DualJog
    ...
    Private Sub DualJog_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            '**************************************************************************
            ...
            '***************************************************
            '* Initialize the amplifier ( for 2-axis drives ecat, AE2, XE2 etc)
            '* 2 axis EtherCAT drives are treated like a single node
            '* on the EtherCAT bus, and therefore are initialized differently
            '***************************************************
            ''''Initialize the first axis
            'ampArray(X_AXIS_AMP).InitializeEcat(ecatObj, X_AXIS_ECAT_NODE)
            ''''Initialize the second axis with the previously initalized X_AXIS_AMP
    ...
    Private Sub DualJog_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        Try
