...
' 1. Upon startup it will enable axis at Can Node ID.
'
...
Public Class IndexerRegViaSDO
    ...
    Private Sub IndexerRegViaSDO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            '**************************************************************************
