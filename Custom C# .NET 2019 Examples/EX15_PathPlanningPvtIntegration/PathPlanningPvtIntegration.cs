//  Example 15 Path Planning PVT Integration
//
...
//
//    After planning is finished, the Path Planning object 
//    will contain all trajectory data needed to command 
//    motion. Simply extract it using the PlayPath method,
//    and load it into a PvtConstAccelTrjObj object. The 
//    speed of the move can be altered by adjusting the 
//    time value in the PVT stream. 
//
...
{
    public partial class PathPlanningPvtIntegration : Form
    {
        //***************************************************
        //
        //  CANOpen Network
        ...
        public PathPlanningPvtIntegration()
        {
            InitializeComponent();
        }
