...
// 1. Upon startup it will enable two axes at Can Node ID 1 & 2 or
//    two axes at EtherCAT Node ID -1 & -2.
//
...
{
    public partial class DualJogging : Form
    {
        //***************************************************
        //*
        //*  EtherCAT Network
        ...
        private void HomeButton2_Click(object sender, EventArgs e) // Home Axis 2 Button
        {
            try
            {                                           
        ...
        private void HomeButton12_Click(object sender, EventArgs e) // Dual Axis Home Button
        {
            try
            {
                HomeButton1.Enabled = false;
