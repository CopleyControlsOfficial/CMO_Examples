    ...
    public partial class Template : Form
    {
        ...
        private void Template_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //// Change a property
                //ampSettings.enableOnInit = false;
                //// NOTE: Some drives (ME3, ME4, etc.) have a different servo loop update rate
                //// from other drives. To initialize, the synchPeriod should be set to 2 ms.
